...
<%
	...
	int groupNum = Group.getGroupNumber("firstStartGroup");
%>
<!doctype html>
<html lang="en">
<head>
...
<body>
					...
					<%
						...
						%>					
								<table class="table table-hover">
									...
									<tbody>
									<%
										for(GroupInfo info:Group.getFirstGroup(i))
										{
											%>
												<tr>
			...
			<div id="subgroup-box">
				...
				<div class="firstJoined">
					...
					<table class="table table-hover">
						...
						<tbody>
						<%
							for(GroupInfo studentInfo:Group.getAllFirstGroup())
							{
								%>
									<tr>
	...
	<div class="pop-box show-sbt-res" >
		<div class="pop-title">一次开题问题反馈</div>
		<div class="pop-content">
			<pre>未进行任何问题反馈</pre>
			<textarea name="sbt-res" id="sbt-res" class="form-control text-quesstion" cols="100" rows="5"></textarea>
	...
	<script src="public/js/subgroup.js"></script>
</body>
</html>